...
{
  Rice::define_class_under<bullet_ruby::VehicleTuning>(rb_mBullet, "VehicleTuning")
    .define_constructor(Rice::Constructor<bullet_ruby::VehicleTuning>())
    .define_method("suspension_stiffness", &bullet_ruby::VehicleTuning::suspension_stiffness)
    .define_method("suspension_stiffness=", &bullet_ruby::VehicleTuning::set_suspension_stiffness)
    .define_method("suspension_compression", &bullet_ruby::VehicleTuning::suspension_compression)
    .define_method("suspension_compression=", &bullet_ruby::VehicleTuning::set_suspension_compression)
    .define_method("suspension_damping", &bullet_ruby::VehicleTuning::suspension_damping)
    .define_method("suspension_damping=", &bullet_ruby::VehicleTuning::set_suspension_damping)
    .define_method("max_suspension_travel_cm", &bullet_ruby::VehicleTuning::max_suspension_travel_cm)
    .define_method("max_suspension_travel_cm=", &bullet_ruby::VehicleTuning::set_max_suspension_travel_cm)
    .define_method("friction_slip", &bullet_ruby::VehicleTuning::friction_slip)
    .define_method("friction_slip=", &bullet_ruby::VehicleTuning::set_friction_slip)
    .define_method("max_suspension_force", &bullet_ruby::VehicleTuning::max_suspension_force)
    .define_method("max_suspension_force=", &bullet_ruby::VehicleTuning::set_max_suspension_force);

  Rice::define_class_under<bullet_ruby::WheelInfo>(rb_mBullet, "WheelInfo")
    .define_method("index", &bullet_ruby::WheelInfo::index)
    .define_method("front_wheel?", &bullet_ruby::WheelInfo::front_wheel)
    .define_method("world_transform", &bullet_ruby::WheelInfo::world_transform)
    .define_method("chassis_connection_point", &bullet_ruby::WheelInfo::chassis_connection_point)
    .define_method("wheel_direction", &bullet_ruby::WheelInfo::wheel_direction)
    .define_method("wheel_axle", &bullet_ruby::WheelInfo::wheel_axle)
    .define_method("suspension_rest_length", &bullet_ruby::WheelInfo::suspension_rest_length)
    .define_method("radius", &bullet_ruby::WheelInfo::radius)
    .define_method("suspension_stiffness", &bullet_ruby::WheelInfo::suspension_stiffness)
    .define_method("suspension_stiffness=", &bullet_ruby::WheelInfo::set_suspension_stiffness)
    .define_method("damping_compression", &bullet_ruby::WheelInfo::damping_compression)
    .define_method("damping_compression=", &bullet_ruby::WheelInfo::set_damping_compression)
    .define_method("damping_relaxation", &bullet_ruby::WheelInfo::damping_relaxation)
    .define_method("damping_relaxation=", &bullet_ruby::WheelInfo::set_damping_relaxation)
    .define_method("friction_slip", &bullet_ruby::WheelInfo::friction_slip)
    .define_method("friction_slip=", &bullet_ruby::WheelInfo::set_friction_slip)
    .define_method("steering", &bullet_ruby::WheelInfo::steering)
    .define_method("rotation", &bullet_ruby::WheelInfo::rotation)
    .define_method("delta_rotation", &bullet_ruby::WheelInfo::delta_rotation)
    .define_method("roll_influence", &bullet_ruby::WheelInfo::roll_influence)
    .define_method("roll_influence=", &bullet_ruby::WheelInfo::set_roll_influence)
    .define_method("engine_force", &bullet_ruby::WheelInfo::engine_force)
    .define_method("brake", &bullet_ruby::WheelInfo::brake)
    .define_method("suspension_force", &bullet_ruby::WheelInfo::suspension_force)
    .define_method("skid_info", &bullet_ruby::WheelInfo::skid_info)
    .define_method("contact?", &bullet_ruby::WheelInfo::contact)
    .define_method("contact_point", &bullet_ruby::WheelInfo::contact_point)
    .define_method("contact_normal", &bullet_ruby::WheelInfo::contact_normal);

  Rice::define_class_under<bullet_ruby::RaycastVehicle>(rb_mBullet, "RaycastVehicle")
    .define_constructor(Rice::Constructor<bullet_ruby::RaycastVehicle,
        bullet_ruby::VehicleTuning&,
        bullet_ruby::DiscreteDynamicsWorld&,
        bullet_ruby::RigidBody&>(),
      Rice::Arg("tuning").keepAlive(),
      Rice::Arg("world").keepAlive(),
      Rice::Arg("chassis").keepAlive())
    .define_method("add_wheel", &bullet_ruby::RaycastVehicle::add_wheel,
    ...
    .define_method("num_wheels", &bullet_ruby::RaycastVehicle::num_wheels)
    .define_method("wheel_info", &bullet_ruby::RaycastVehicle::wheel_info)
    .define_method("wheel_transform", &bullet_ruby::RaycastVehicle::wheel_transform)
    .define_method("update_wheel_transform", &bullet_ruby::RaycastVehicle::update_wheel_transform,
      Rice::Arg("index"),
      Rice::Arg("interpolated_transform") = true)
    .define_method("chassis_world_transform", &bullet_ruby::RaycastVehicle::chassis_world_transform)
    .define_method("steering_value", &bullet_ruby::RaycastVehicle::steering_value)
    .define_method("set_steering_value", &bullet_ruby::RaycastVehicle::set_steering_value)
    .define_method("apply_engine_force", &bullet_ruby::RaycastVehicle::apply_engine_force)
    .define_method("set_brake", &bullet_ruby::RaycastVehicle::set_brake)
    .define_method("reset_suspension", &bullet_ruby::RaycastVehicle::reset_suspension)
    .define_method("current_speed_km_hour", &bullet_ruby::RaycastVehicle::current_speed_km_hour)
    .define_method("forward_vector", &bullet_ruby::RaycastVehicle::forward_vector)
    .define_method("pitch_control=", &bullet_ruby::RaycastVehicle::set_pitch_control)
    .define_method("set_coordinate_system", &bullet_ruby::RaycastVehicle::set_coordinate_system)
    .define_method("coordinate_system", &bullet_ruby::RaycastVehicle::coordinate_system)
    .define_method("update_vehicle", &bullet_ruby::RaycastVehicle::update_vehicle);
}
