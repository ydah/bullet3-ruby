...
btSliderConstraint* slider_from(bullet_ruby::TypedConstraint& constraint)
{
  return static_cast<btSliderConstraint*>(constraint.get());
}

const btSliderConstraint* slider_from(const bullet_ruby::TypedConstraint& constraint)
{
  return static_cast<const btSliderConstraint*>(constraint.get());
}

btConeTwistConstraint* cone_twist_from(bullet_ruby::TypedConstraint& constraint)
{
  return static_cast<btConeTwistConstraint*>(constraint.get());
}

const btConeTwistConstraint* cone_twist_from(const bullet_ruby::TypedConstraint& constraint)
{
  return static_cast<const btConeTwistConstraint*>(constraint.get());
}

btGeneric6DofConstraint* generic_6dof_from(bullet_ruby::TypedConstraint& constraint)
{
  return static_cast<btGeneric6DofConstraint*>(constraint.get());
}

const btGeneric6DofConstraint* generic_6dof_from(const bullet_ruby::TypedConstraint& constraint)
{
  return static_cast<const btGeneric6DofConstraint*>(constraint.get());
}

btGeneric6DofSpring2Constraint* generic_6dof_spring2_from(bullet_ruby::TypedConstraint& constraint)
{
  return static_cast<btGeneric6DofSpring2Constraint*>(constraint.get());
}

btGeneric6DofSpring2Constraint* generic_6dof_spring2_from(const bullet_ruby::TypedConstraint& constraint)
{
  return const_cast<btGeneric6DofSpring2Constraint*>(
    static_cast<const btGeneric6DofSpring2Constraint*>(constraint.get()));
}

btGearConstraint* gear_from(bullet_ruby::TypedConstraint& constraint)
{
  return static_cast<btGearConstraint*>(constraint.get());
}

const btGearConstraint* gear_from(const bullet_ruby::TypedConstraint& constraint)
{
  return static_cast<const btGearConstraint*>(constraint.get());
}

btHinge2Constraint* hinge2_from(bullet_ruby::TypedConstraint& constraint)
{
...
{
  btVector3 anchor = bullet_ruby::coerce_vector(Rice::Object(anchor_value));
  btVector3 axis1 = bullet_ruby::coerce_vector(Rice::Object(axis1_value));
  btVector3 axis2 = bullet_ruby::coerce_vector(Rice::Object(axis2_value));
...
void Init_Constraints(Rice::Module rb_mBullet)
{
  ...
  Rice::define_class_under<bullet_ruby::SliderConstraint, bullet_ruby::TypedConstraint>(rb_mConstraints, "SliderConstraint")
    .define_constructor(Rice::Constructor<bullet_ruby::SliderConstraint, VALUE, VALUE, bool>(),
      Rice::Arg("rigid_body_b").setValue().keepAlive(),
      Rice::Arg("frame_b").setValue(),
      Rice::Arg("use_linear_reference_frame_a") = true)
    .define_constructor(Rice::Constructor<bullet_ruby::SliderConstraint, VALUE, VALUE, VALUE, VALUE, bool>(),
      Rice::Arg("rigid_body_a").setValue().keepAlive(),
      Rice::Arg("rigid_body_b").setValue().keepAlive(),
      Rice::Arg("frame_a").setValue(),
      Rice::Arg("frame_b").setValue(),
      Rice::Arg("use_linear_reference_frame_a") = true)
    .define_method("frame_a", &bullet_ruby::SliderConstraint::frame_a)
    .define_method("frame_b", &bullet_ruby::SliderConstraint::frame_b)
    .define_method("set_frames", &bullet_ruby::SliderConstraint::set_frames,
      Rice::Arg("frame_a").setValue(),
      Rice::Arg("frame_b").setValue())
    .define_method("lower_linear_limit", &bullet_ruby::SliderConstraint::lower_linear_limit)
    .define_method("lower_linear_limit=", &bullet_ruby::SliderConstraint::set_lower_linear_limit)
    .define_method("upper_linear_limit", &bullet_ruby::SliderConstraint::upper_linear_limit)
    .define_method("upper_linear_limit=", &bullet_ruby::SliderConstraint::set_upper_linear_limit)
    .define_method("lower_angular_limit", &bullet_ruby::SliderConstraint::lower_angular_limit)
    .define_method("lower_angular_limit=", &bullet_ruby::SliderConstraint::set_lower_angular_limit)
    .define_method("upper_angular_limit", &bullet_ruby::SliderConstraint::upper_angular_limit)
    .define_method("upper_angular_limit=", &bullet_ruby::SliderConstraint::set_upper_angular_limit)
    .define_method("linear_position", &bullet_ruby::SliderConstraint::linear_position)
    .define_method("angular_position", &bullet_ruby::SliderConstraint::angular_position)
    .define_method("powered_linear_motor?", &bullet_ruby::SliderConstraint::powered_linear_motor)
    .define_method("powered_linear_motor=", &bullet_ruby::SliderConstraint::set_powered_linear_motor)
    .define_method("target_linear_motor_velocity", &bullet_ruby::SliderConstraint::target_linear_motor_velocity)
    .define_method("target_linear_motor_velocity=", &bullet_ruby::SliderConstraint::set_target_linear_motor_velocity)
    .define_method("max_linear_motor_force", &bullet_ruby::SliderConstraint::max_linear_motor_force)
    .define_method("max_linear_motor_force=", &bullet_ruby::SliderConstraint::set_max_linear_motor_force)
    .define_method("powered_angular_motor?", &bullet_ruby::SliderConstraint::powered_angular_motor)
    .define_method("powered_angular_motor=", &bullet_ruby::SliderConstraint::set_powered_angular_motor)
    .define_method("target_angular_motor_velocity", &bullet_ruby::SliderConstraint::target_angular_motor_velocity)
    .define_method("target_angular_motor_velocity=", &bullet_ruby::SliderConstraint::set_target_angular_motor_velocity)
    .define_method("max_angular_motor_force", &bullet_ruby::SliderConstraint::max_angular_motor_force)
    .define_method("max_angular_motor_force=", &bullet_ruby::SliderConstraint::set_max_angular_motor_force);

  Rice::define_class_under<bullet_ruby::ConeTwistConstraint, bullet_ruby::TypedConstraint>(rb_mConstraints, "ConeTwistConstraint")
    .define_constructor(Rice::Constructor<bullet_ruby::ConeTwistConstraint, VALUE, VALUE>(),
      Rice::Arg("rigid_body_a").setValue().keepAlive(),
      Rice::Arg("frame_a").setValue())
    .define_constructor(Rice::Constructor<bullet_ruby::ConeTwistConstraint, VALUE, VALUE, VALUE, VALUE>(),
      Rice::Arg("rigid_body_a").setValue().keepAlive(),
      Rice::Arg("rigid_body_b").setValue().keepAlive(),
      Rice::Arg("frame_a").setValue(),
      Rice::Arg("frame_b").setValue())
    .define_method("set_limit", &bullet_ruby::ConeTwistConstraint::set_limit,
      ...
      Rice::Arg("bias_factor") = btScalar(0.3),
      Rice::Arg("relaxation_factor") = btScalar(1.0))
    .define_method("swing_span1", &bullet_ruby::ConeTwistConstraint::swing_span1)
    .define_method("swing_span2", &bullet_ruby::ConeTwistConstraint::swing_span2)
    .define_method("twist_span", &bullet_ruby::ConeTwistConstraint::twist_span)
    .define_method("limit_softness", &bullet_ruby::ConeTwistConstraint::limit_softness)
    .define_method("bias_factor", &bullet_ruby::ConeTwistConstraint::bias_factor)
    .define_method("relaxation_factor", &bullet_ruby::ConeTwistConstraint::relaxation_factor)
    .define_method("twist_angle", &bullet_ruby::ConeTwistConstraint::twist_angle)
    .define_method("angular_only?", &bullet_ruby::ConeTwistConstraint::angular_only)
    .define_method("angular_only=", &bullet_ruby::ConeTwistConstraint::set_angular_only)
    .define_method("damping", &bullet_ruby::ConeTwistConstraint::damping)
    .define_method("damping=", &bullet_ruby::ConeTwistConstraint::set_damping)
    .define_method("motor_enabled?", &bullet_ruby::ConeTwistConstraint::motor_enabled)
    .define_method("enable_motor", &bullet_ruby::ConeTwistConstraint::enable_motor)
    .define_method("max_motor_impulse", &bullet_ruby::ConeTwistConstraint::max_motor_impulse)
    .define_method("max_motor_impulse=", &bullet_ruby::ConeTwistConstraint::set_max_motor_impulse)
    .define_method("motor_target", &bullet_ruby::ConeTwistConstraint::motor_target)
    .define_method("motor_target=", &bullet_ruby::ConeTwistConstraint::set_motor_target)
    .define_method("frame_a", &bullet_ruby::ConeTwistConstraint::frame_a)
    .define_method("frame_b", &bullet_ruby::ConeTwistConstraint::frame_b);

  Rice::define_class_under<bullet_ruby::Generic6DofConstraint, bullet_ruby::TypedConstraint>(rb_mConstraints, "Generic6DofConstraint")
    .define_constructor(Rice::Constructor<bullet_ruby::Generic6DofConstraint, VALUE, VALUE, bool>(),
      Rice::Arg("rigid_body_b").setValue().keepAlive(),
      Rice::Arg("frame_b").setValue(),
      Rice::Arg("use_linear_reference_frame_b") = true)
    .define_constructor(Rice::Constructor<bullet_ruby::Generic6DofConstraint, VALUE, VALUE, VALUE, VALUE, bool>(),
      Rice::Arg("rigid_body_a").setValue().keepAlive(),
      Rice::Arg("rigid_body_b").setValue().keepAlive(),
      Rice::Arg("frame_a").setValue(),
      Rice::Arg("frame_b").setValue(),
      Rice::Arg("use_linear_reference_frame_a") = true)
    .define_method("frame_a", &bullet_ruby::Generic6DofConstraint::frame_a)
    .define_method("frame_b", &bullet_ruby::Generic6DofConstraint::frame_b)
    .define_method("set_frames", &bullet_ruby::Generic6DofConstraint::set_frames,
      Rice::Arg("frame_a").setValue(),
      Rice::Arg("frame_b").setValue())
    .define_method("linear_lower_limit", &bullet_ruby::Generic6DofConstraint::linear_lower_limit)
    .define_method("linear_lower_limit=", &bullet_ruby::Generic6DofConstraint::set_linear_lower_limit)
    .define_method("linear_upper_limit", &bullet_ruby::Generic6DofConstraint::linear_upper_limit)
    .define_method("linear_upper_limit=", &bullet_ruby::Generic6DofConstraint::set_linear_upper_limit)
    .define_method("angular_lower_limit", &bullet_ruby::Generic6DofConstraint::angular_lower_limit)
    .define_method("angular_lower_limit=", &bullet_ruby::Generic6DofConstraint::set_angular_lower_limit)
    .define_method("angular_upper_limit", &bullet_ruby::Generic6DofConstraint::angular_upper_limit)
    .define_method("angular_upper_limit=", &bullet_ruby::Generic6DofConstraint::set_angular_upper_limit)
    .define_method("set_limit", &bullet_ruby::Generic6DofConstraint::set_limit)
    .define_method("limited?", &bullet_ruby::Generic6DofConstraint::limited)
    .define_method("axis", &bullet_ruby::Generic6DofConstraint::axis)
    .define_method("angle", &bullet_ruby::Generic6DofConstraint::angle)
    .define_method("relative_pivot_position", &bullet_ruby::Generic6DofConstraint::relative_pivot_position)
    .define_method("use_frame_offset?", &bullet_ruby::Generic6DofConstraint::use_frame_offset)
    .define_method("use_frame_offset=", &bullet_ruby::Generic6DofConstraint::set_use_frame_offset)
    .define_method("use_linear_reference_frame_a?", &bullet_ruby::Generic6DofConstraint::use_linear_reference_frame_a)
    .define_method("use_linear_reference_frame_a=", &bullet_ruby::Generic6DofConstraint::set_use_linear_reference_frame_a)
    .define_method("set_axis", &bullet_ruby::Generic6DofConstraint::set_axis);

  Rice::define_class_under<bullet_ruby::Generic6DofSpring2Constraint, bullet_ruby::TypedConstraint>(rb_mConstraints, "Generic6DofSpring2Constraint")
    .define_constructor(Rice::Constructor<bullet_ruby::Generic6DofSpring2Constraint, VALUE, VALUE, int>(),
      Rice::Arg("rigid_body_b").setValue().keepAlive(),
      Rice::Arg("frame_b").setValue(),
      Rice::Arg("rotate_order") = 0)
    .define_constructor(Rice::Constructor<bullet_ruby::Generic6DofSpring2Constraint, VALUE, VALUE, VALUE, VALUE, int>(),
      Rice::Arg("rigid_body_a").setValue().keepAlive(),
      Rice::Arg("rigid_body_b").setValue().keepAlive(),
      Rice::Arg("frame_a").setValue(),
      Rice::Arg("frame_b").setValue(),
      Rice::Arg("rotate_order") = 0)
    .define_method("frame_a", &bullet_ruby::Generic6DofSpring2Constraint::frame_a)
    .define_method("frame_b", &bullet_ruby::Generic6DofSpring2Constraint::frame_b)
    .define_method("set_frames", &bullet_ruby::Generic6DofSpring2Constraint::set_frames,
      Rice::Arg("frame_a").setValue(),
      Rice::Arg("frame_b").setValue())
    .define_method("linear_lower_limit", &bullet_ruby::Generic6DofSpring2Constraint::linear_lower_limit)
    .define_method("linear_lower_limit=", &bullet_ruby::Generic6DofSpring2Constraint::set_linear_lower_limit)
    .define_method("linear_upper_limit", &bullet_ruby::Generic6DofSpring2Constraint::linear_upper_limit)
    .define_method("linear_upper_limit=", &bullet_ruby::Generic6DofSpring2Constraint::set_linear_upper_limit)
    .define_method("angular_lower_limit", &bullet_ruby::Generic6DofSpring2Constraint::angular_lower_limit)
    .define_method("angular_lower_limit=", &bullet_ruby::Generic6DofSpring2Constraint::set_angular_lower_limit)
    .define_method("angular_upper_limit", &bullet_ruby::Generic6DofSpring2Constraint::angular_upper_limit)
    .define_method("angular_upper_limit=", &bullet_ruby::Generic6DofSpring2Constraint::set_angular_upper_limit)
    .define_method("set_limit", &bullet_ruby::Generic6DofSpring2Constraint::set_limit)
    .define_method("limited?", &bullet_ruby::Generic6DofSpring2Constraint::limited)
    .define_method("axis", &bullet_ruby::Generic6DofSpring2Constraint::axis)
    .define_method("angle", &bullet_ruby::Generic6DofSpring2Constraint::angle)
    .define_method("relative_pivot_position", &bullet_ruby::Generic6DofSpring2Constraint::relative_pivot_position)
    .define_method("rotation_order", &bullet_ruby::Generic6DofSpring2Constraint::rotation_order)
    .define_method("rotation_order=", &bullet_ruby::Generic6DofSpring2Constraint::set_rotation_order)
    .define_method("set_axis", &bullet_ruby::Generic6DofSpring2Constraint::set_axis)
    .define_method("enable_motor", &bullet_ruby::Generic6DofSpring2Constraint::enable_motor)
    .define_method("set_servo", &bullet_ruby::Generic6DofSpring2Constraint::set_servo)
    .define_method("set_target_velocity", &bullet_ruby::Generic6DofSpring2Constraint::set_target_velocity)
    .define_method("set_servo_target", &bullet_ruby::Generic6DofSpring2Constraint::set_servo_target)
    .define_method("set_max_motor_force", &bullet_ruby::Generic6DofSpring2Constraint::set_max_motor_force)
    .define_method("enable_spring", &bullet_ruby::Generic6DofSpring2Constraint::enable_spring)
    .define_method("set_stiffness", &bullet_ruby::Generic6DofSpring2Constraint::set_stiffness,
      Rice::Arg("axis"),
      Rice::Arg("stiffness"),
      Rice::Arg("limit_if_needed") = true)
    .define_method("set_damping", &bullet_ruby::Generic6DofSpring2Constraint::set_damping,
      Rice::Arg("axis"),
      Rice::Arg("damping"),
      Rice::Arg("limit_if_needed") = true)
    .define_method("set_equilibrium_point", &bullet_ruby::Generic6DofSpring2Constraint::set_equilibrium_point)
    .define_method("set_axis_equilibrium_point", &bullet_ruby::Generic6DofSpring2Constraint::set_axis_equilibrium_point)
    .define_method("set_axis_equilibrium_point_value", &bullet_ruby::Generic6DofSpring2Constraint::set_axis_equilibrium_point_value);

  Rice::define_class_under<bullet_ruby::GearConstraint, bullet_ruby::TypedConstraint>(rb_mConstraints, "GearConstraint")
    .define_constructor(Rice::Constructor<bullet_ruby::GearConstraint, VALUE, VALUE, VALUE, VALUE, btScalar>(),
      Rice::Arg("rigid_body_a").setValue().keepAlive(),
      Rice::Arg("rigid_body_b").setValue().keepAlive(),
      Rice::Arg("axis_a").setValue(),
      Rice::Arg("axis_b").setValue(),
      Rice::Arg("ratio") = btScalar(1.0))
    .define_method("axis_a", &bullet_ruby::GearConstraint::axis_a)
    .define_method("axis_a=", &bullet_ruby::GearConstraint::set_axis_a)
    .define_method("axis_b", &bullet_ruby::GearConstraint::axis_b)
    .define_method("axis_b=", &bullet_ruby::GearConstraint::set_axis_b)
    .define_method("ratio", &bullet_ruby::GearConstraint::ratio)
    .define_method("ratio=", &bullet_ruby::GearConstraint::set_ratio);

  Rice::define_class_under<bullet_ruby::Hinge2Constraint, bullet_ruby::TypedConstraint>(rb_mConstraints, "Hinge2Constraint")
    .define_constructor(Rice::Constructor<bullet_ruby::Hinge2Constraint, VALUE, VALUE, VALUE, VALUE, VALUE>(),
      Rice::Arg("rigid_body_a").setValue().keepAlive(),
      Rice::Arg("rigid_body_b").setValue().keepAlive(),
      Rice::Arg("anchor").setValue(),
      Rice::Arg("axis1").setValue(),
      Rice::Arg("axis2").setValue())
    .define_method("anchor", &bullet_ruby::Hinge2Constraint::anchor)
    .define_method("anchor2", &bullet_ruby::Hinge2Constraint::anchor2)
    .define_method("axis1", &bullet_ruby::Hinge2Constraint::axis1)
    .define_method("axis2", &bullet_ruby::Hinge2Constraint::axis2)
    .define_method("angle1", &bullet_ruby::Hinge2Constraint::angle1)
    .define_method("angle2", &bullet_ruby::Hinge2Constraint::angle2)
    .define_method("set_upper_limit", &bullet_ruby::Hinge2Constraint::set_upper_limit)
    .define_method("set_lower_limit", &bullet_ruby::Hinge2Constraint::set_lower_limit);
}
